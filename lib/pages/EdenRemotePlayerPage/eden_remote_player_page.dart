  ...
  Future<List<_RemoteGalleryCharacter>> _loadCharacters() async {
    ...
    try {
      ...
      if (response.statusCode < 200 || response.statusCode >= 300) {
        throw StateError(
          'Manifest load failed: HTTP ${response.statusCode}\n$text',
        );
      }
      ...
      return rawCharacters
          ...
          .map(_RemoteGalleryCharacter.fromJson)
...
class _RemotePlayerScaffold extends StatefulWidget {
  ...
  @override
  State<_RemotePlayerScaffold> createState() => _RemotePlayerScaffoldState();
}

class _RemotePlayerScaffoldState extends State<_RemotePlayerScaffold> {
                  ...
                  Expanded(
                    child: _PersistentOverlayVisibility(
                      ...
                      child: _CharacterStrip(
                        ...
                        assetUrlBuilder: widget.assetUrlBuilder,
...
class _RemoteGalleryCharacter {
  ...
  factory _RemoteGalleryCharacter.fromJson(Map<String, dynamic> json) {
